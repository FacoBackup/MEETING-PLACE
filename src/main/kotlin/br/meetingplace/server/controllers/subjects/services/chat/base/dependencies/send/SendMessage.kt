...
import br.meetingplace.server.controllers.subjects.services.chat.dependencies.factory.ChatFactory
...
class SendMessage private constructor() : SendMessageInterface {
    companion object {
    ...
    override fun sendUserMessage(data: MessageData) {
    ...
    override fun sendGroupMessage(data: MessageData) {
