package br.meetingplace.management.dependencies.verify.dependencies
...
interface Verify: ReadWriteLoggedUser {
    ...
    fun verifyLoggedUser(user: User): Boolean {
        ...
        return logged.email.isNotBlank() && logged.password.isNotBlank()&& logged.email == user.getEmail() && logged.password == user.getPassword()  && user.getAge() >= 16
    }
