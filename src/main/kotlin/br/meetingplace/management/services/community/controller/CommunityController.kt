package br.meetingplace.management.services.community.controller
...
class CommunityController private constructor(): FollowerInterface, CommunityFactoryInterface, ModeratorInterface{
    ...
    companion object{
        private val Class = CommunityController()
        fun getClass() = Class
    }
