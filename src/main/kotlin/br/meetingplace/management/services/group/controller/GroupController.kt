package br.meetingplace.management.services.group.controller
...
class GroupController private constructor(): GroupFactoryInterface, GroupManagementInterface, GroupReaderInterface{

    companion object{
        private val Class = GroupController()
        fun getClass () = Class
    }
